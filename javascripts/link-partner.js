...
function articleAnim(e,t)
	...
	).from(e.querySelector(".eliyantosarage"),.5,
		{
...
function articleHover(e)
	...
	),e.timeline.to(e.querySelector(".eliyantosarage"),.15,
		{
		scale:1.25
	}
...
setTimeout(run,500),eval(function(e,t,n,i,a,r)
	...
	forEach($articles,function(e,t)
		{
		window.matchMedia("(min-width: 768px)").matches?TweenMax.set(t.querySelector(".eliyantosarage"),
			{
			x:"0%",y:"0%"
		}
		):TweenMax.set(t.querySelector(".eliyantosarage"),
			{
			x:"-50%",y:"-50%"
		}
		)
